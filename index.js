...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/iframe-resizer/js/iframeResizer.js":[function(require,module,exports) {
var define;
/*
...
},{}],"components/AnalyticsView.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    dashboardUrl: function dashboardUrl() {
      return "https://app.usefathom.com/share/".concat(this.config.siteId, "/kirby?password=").concat(this.config.sharePassword);
    }
  },
  mounted: function mounted() {
    var _this = this;

    this.$api.get("fathom-analytics").then(function (response) {
      _this.config.siteId = response.siteId;
      _this.config.sharePassword = response.sharePassword;

      if (!_this.config.siteId) {
        _this.error = true;

        _this.errors.push(_this.$t("paulmorel.fathom-analytics.siteId-missing"));
      }
    }).finally(function () {
      _this.loaded = true;
    });
...
exports.default = _default;
        var $baab02 = exports.default || module.exports;
      
      if (typeof $baab02 === 'function') {
        $baab02 = $baab02.options;
      }
    
        /* template */
        Object.assign($baab02, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "k-view",
    {
      ...
      staticClass: "k-analytics-view"
    },
    [
      _c("k-header", [
        _vm._v(_vm._s(_vm.$t("paulmorel.fathom-analytics.analytics")))
      ]),
      _vm._v(" "),
      _vm.error
        ? [
            _c(
              ...
              _vm._l(_vm.errors, function(error, index) {
                return _c("k-text", { key: "error-" + index }, [
                  _vm._v("\n        " + _vm._s(error) + "\n      ")
                ])
              }),
              1
      ...
      _c(
        ...
        [
          _vm.iframe.loaded == false
            ? _c("k-loader", { attrs: { position: "center" } })
            : _vm._e(),
          _vm._v(" "),
          _c("iframe", {
            staticClass: "fathom-analytics-iframe",
            attrs: { src: _vm.dashboardUrl, frameborder: "0" },
            on: { load: _vm.resize }
          })
        ],
        1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$baab02', $baab02);
          } else {
            api.reload('$baab02', $baab02);
          }
        }
...
},{"iframe-resizer/js/iframeResizer":"../node_modules/iframe-resizer/js/iframeResizer.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _AnalyticsView = _interopRequireDefault(require("./components/AnalyticsView.vue"));
...
panel.plugin("paulmorel/fathom-analytics", {
  views: _defineProperty({}, 'analytics', {
    component: _AnalyticsView.default,
    icon: "chart",
    label: 'Analytics',
    menu: true
  })
});
},{"./components/AnalyticsView.vue":"components/AnalyticsView.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
